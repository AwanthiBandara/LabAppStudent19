...
<div class="top-section">
    <div class="container">
        <h3>Welcome,  <%= loggedInUser.getFirstName() + " " + loggedInUser.getLastName() %> to the Lab Technician Dashboard</h3> 
        <p>Welcome to the Lab Patient Dashboard! Your gateway to efficient patient management and seamless appointment scheduling.</p>
    </div>
