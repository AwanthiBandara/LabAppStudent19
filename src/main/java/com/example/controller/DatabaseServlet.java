...
//                    response.sendRedirect("login.jsp?error=1");
 ...
 // Helper method to create table header cell
    private static PdfPCell createHeaderCell(String text) {
        ...
        headerCell.setBackgroundColor(new BaseColor(218, 112, 214));
    ...
    protected void generateAndDownloadReport(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            Paragraph subheader = new Paragraph("ABC Laboratory, New York", fontSubheader);
            ...
            // Description
            Paragraph description = new Paragraph("The individual received an extensive medical assessment comprising blood tests, urine analysis, and imaging studies. Findings revealed typical levels of blood glucose, cholesterol, and blood pressure falling within healthy parameters. Furthermore, the urine analysis detected no irregularities.", fontSmall);
         ...
         // Description
            Paragraph trustDescription = new Paragraph("At ABC Laboratory, we uphold rigorous quality control standards and adhere to standardized protocols to guarantee precise and dependable test outcomes. Our dedication lies in delivering top-tier diagnostic services with the utmost professionalism and integrity. Your confidence in our services is paramount to us. For any questions or support, please reach out to us at abclaboratory012@gmail.com or call +94771197087.", fontSmall);
...
//        request.getRequestDispatcher("/view_appointments.jsp").forward(request, response);
    ...
    void sendEmail(HttpServletRequest request, HttpServletResponse response, String firstName, String lastName, String userType, int userId, String password, String email, String description) 
            throws ServletException, IOException {
    	String senderEmail = "abclaboratory012@gmail.com";
        String senderPassword = "ibaz bcvk zwrz pfww";
